...
#define LOC_KO_EN(koreanText, englishText) {koreanText, englishText}
        ...
        constexpr Entry kText[] = {
            ...
            LOC_KO_EN("이동 예측 보정", "Lead prediction"),
            LOC_KO_EN("투척 무기 및 발사체가 이동 중인 적의 미래 위치를 계산하여 유도합니다.",
                      "Predicts moving target position for thrown weapons and projectiles."),
            ...
            LOC_KO_EN("그래프 글자·선 불투명도", "Graph text / line opacity"),
